...
def test_recommend_next_concepts():
    ...
    recs = recommend_next_concepts(state, concepts, min_score=0.5, min_evidence_coverage=0.2)
...
def test_recommend_reinforcement_targets():
    ...
    recs = recommend_reinforcement_targets(state, low_evidence_coverage_threshold=0.5)
